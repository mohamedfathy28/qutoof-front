		...
		const fetchData = async () => {
			...
			try {
				const response = await fetch(
					`https://quttouf.com/api/user/market?per_page=${PerPage}&page=${CurrentPage}`,
					{
						headers: myHeaders,
					}
				);
...
const RenderFromCustomers = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			try {
				const response = await fetch(
					`https://quttouf.com/api/user/market?filter[type_id]=2&per_page=${PerPage}&page=${CurrentPage}`,
					{
						headers: myHeaders,
					}
				);
...
const RenderFromCompany = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			try {
				const response = await fetch(
					`https://quttouf.com/api/user/market?filter[type_id]=1&per_page=${PerPage}&page=${CurrentPage}`,
					{
						headers: myHeaders,
					}
				);
