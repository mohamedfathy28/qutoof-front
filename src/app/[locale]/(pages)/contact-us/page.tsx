...
const ContactUsPage: React.FC = () => {
	...
	return (
		<>
			<Breadcrumb items={[{ label: t("contactUs"), href: "/contact-us" }]} />
			<div className='max-w-[90%] mx-auto sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl'>
				<div className='py-20 md:py-32 grid grid-col-1 md:grid-cols-2 gap-16'>
					<div className='flex flex-col gap-12'>
						<div>
							<h4 className='text-[42px] md:text-[52px] text-[#000] font-[600] mb-6'>
								{t("GetInTouch")}
							</h4>
						</div>
						...
						<div className='flex flex-col gap-6'>
							<h6 className='text-[24px] text-[#000] font-[600] leading-[30px]'>
								{t("FollowUs")}
							</h6>
							<div className='flex items-center gap-4'>
								...
								>
									...
									>
										<path
											d='M4.5625 4.46875V2.84375C4.5625 2.6237 4.6429 2.43327 4.80371 2.27246C4.96452 2.11165 5.15495 2.03125 5.375 2.03125H6.1875V0H4.5625C3.88542 0 3.3099 0.236979 2.83594 0.710938C2.36198 1.1849 2.125 1.76042 2.125 2.4375V4.46875H0.5V6.5H2.125V13H4.5625V6.5H6.1875L7 4.46875H4.5625Z'
											fill='#1F1E17'
										/>
									</svg>
								</a>
					...
					<div className='rounded-[12px] bg-[#F4F8ED] p-8 flex flex-col justify-center'>
						<p className='text-[#31A13A] text-[16px] font-[500] mb-4'>
							{t("HaveAQuestion")}
						</p>
						<h2 className='text-[#000] text-[40px] md:text-[50px] font-[600] mb-10'>
							{t("SendUsAMessage")}
						</h2>
						<Formik
							initialValues={{
