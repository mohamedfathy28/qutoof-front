                    ...
                    <div>
                        ...
                        <ul className='grid grid-cols-1 lg:grid-cols-2 gap-4 pb-6 mb-6 border-b border-[#F1F1F1]'>
                            ...
                            <li className='flex items-center gap-3'>
                                <span className='w-14 h-14 rounded-[50%] bg-[#E6F4EC] flex items-center justify-center'>
                                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.9544 6.07825L19.5994 9.36825C19.821 9.82325 20.416 10.2549 20.9177 10.3482L23.8927 10.8382C25.7944 11.1532 26.2377 12.5299 24.8727 13.9066L22.551 16.2282C22.166 16.6132 21.9444 17.3716 22.0727 17.9199L22.7377 20.7899C23.2627 23.0532 22.0494 23.9399 20.0544 22.7499L17.266 21.0933C16.7644 20.7899 15.9244 20.7899 15.4227 21.0933L12.6344 22.7499C10.6394 23.9283 9.42603 23.0532 9.95103 20.7899L10.616 17.9199C10.721 17.3599 10.4994 16.6016 10.1144 16.2166L7.7927 13.8949C6.4277 12.5299 6.87103 11.1532 8.7727 10.8266L11.7477 10.3366C12.2494 10.2549 12.8444 9.81158 13.066 9.35658L14.711 6.06658C15.6094 4.29325 17.056 4.29325 17.9544 6.07825Z" fill="#009444" />
                                        <path d="M9.33398 6.70825H2.33398C1.85565 6.70825 1.45898 6.31159 1.45898 5.83325C1.45898 5.35492 1.85565 4.95825 2.33398 4.95825H9.33398C9.81232 4.95825 10.209 5.35492 10.209 5.83325C10.209 6.31159 9.81232 6.70825 9.33398 6.70825Z" fill="#009444" />
                                        <path d="M5.83398 23.0417H2.33398C1.85565 23.0417 1.45898 22.6451 1.45898 22.1667C1.45898 21.6884 1.85565 21.2917 2.33398 21.2917H5.83398C6.31232 21.2917 6.70898 21.6884 6.70898 22.1667C6.70898 22.6451 6.31232 23.0417 5.83398 23.0417Z" fill="#009444" />
                                        <path d="M3.50065 14.875H2.33398C1.85565 14.875 1.45898 14.4783 1.45898 14C1.45898 13.5217 1.85565 13.125 2.33398 13.125H3.50065C3.97898 13.125 4.37565 13.5217 4.37565 14C4.37565 14.4783 3.97898 14.875 3.50065 14.875Z" fill="#009444" />
                                    </svg>
                                </span>
                                <div className='flex flex-col'>
