...
const SectorDetails = ({ sectorId }: Iprops) => {
	...
	// helpers to handle null/empty and numeric strings
			...
			<div className='mx-auto max-w-[90%] sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl py-20 md:py-32'>
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12'>
					...
					<div>
						...
						{(hasValue(data?.land_area) || hasValue(data?.available_shares) || hasValue(data?.number_of_acres) || (data?.AllowToSell && hasValue(data?.share_price))) && (
							<ul className='grid grid-cols-1 lg:grid-cols-2 gap-4 pb-6 mb-6 border-b border-[#F1F1F1]'>
								{hasValue(data?.land_area) && (
									<li className='flex items-center gap-3'>
										...
										<div className='flex flex-col'>
											...
											<p className='text-[#000] text-[18px] font-[500]'>
												{toNumber(data?.land_area)} {t_home("meter")}
											</p>
										</div>
									</li>
								)}
								{hasValue(data?.available_shares) && (
									<li className='flex items-center gap-3'>
										<span className='w-14 h-14 rounded-[50%] bg-[#E6F4EC] flex items-center justify-center'>
											<svg
												width='28'
										...
										<div className='flex flex-col'>
											...
											<p className='text-[#000] text-[18px] font-[500]'>
												{toNumber(data?.available_shares)}
											</p>
										</div>
									</li>
								)}
								{hasValue(data?.number_of_acres) && (
									<li className='flex items-center gap-3'>
										<span className='w-14 h-14 rounded-[50%] bg-[#E6F4EC] flex items-center justify-center'>
											<svg
												width='28'
										...
										<div className='flex flex-col'>
											...
											<p className='text-[#000] text-[18px] font-[500]'>
												{toNumber(data?.number_of_acres)} {t_home("acre")}
											</p>
										</div>
									</li>
								)}
								{data?.AllowToSell && hasValue(data?.share_price) && (
									<li className='flex items-center gap-3'>
										<span className='w-14 h-14 rounded-[50%] bg-[#E6F4EC] flex items-center justify-center'>
											<svg
												width='28'
										...
										<div className='flex flex-col'>
											...
											<p className='text-[#000] text-[18px] font-[500]'>
												{toNumber(data?.share_price)} {t("currency")}
											</p>
										</div>
