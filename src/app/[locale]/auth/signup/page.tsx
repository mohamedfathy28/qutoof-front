			...
			<form onSubmit={formik.handleSubmit} className='space-y-4'>
				...
				<div className='space-y-1 mb-4'>
					<label
						...
						className='text-[#656C77] text-[16px] leading-[24px] font-[500]'
					>
						{t("messages.password_confirmation_label")}
					</label>
				...
				<Button type='submit' className='w-full'>
					{formik.isSubmitting
						? t("messages.signing_up")
						: t("messages.signin_link")}
				</Button>

				<p className='text-center'>
					{t("messages.signin_redirect")}{" "}
					<Link href='/auth/signin' className='text-[#009444]'>
						{t("messages.signin_link")}
					</Link>
				</p>
			</form>
