        ...
        <div className="w-full max-w-md space-y-4">
            <label className='relative w-28 h-28 border-2 border-[#A2A1A833] bg-[#A2A1A80D] hover:bg-[#a2a1a845] duration-200 cursor-pointer rounded-[10px] flex items-center justify-center overflow-hidden'>
                ...
                <input type="file" name="" id="" onChange={handleFileChange}
                    accept={acceptedFileTypes.join(',')} className='absolute top-0 left-0 w-full h-full z-[2] opacity-0 cursor-pointer' />
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 13.5C15 15.1569 13.6569 16.5 12 16.5C10.3431 16.5 9 15.1569 9 13.5C9 11.8431 10.3431 10.5 12 10.5C13.6569 10.5 15 11.8431 15 13.5Z" stroke="#252525" strokeWidth="1.5" />
                    <circle cx="12" cy="7" r="1" fill="#252525" />
                    <path d="M21 15.5V11.5C21 8.73858 18.7614 6.5 16 6.5H15.874C15.4299 4.77477 13.8638 3.5 12 3.5C10.1362 3.5 8.57006 4.77477 8.12602 6.5H8C5.23858 6.5 3 8.73858 3 11.5V15.5C3 18.2614 5.23858 20.5 8 20.5H16C18.7614 20.5 21 18.2614 21 15.5Z" stroke="#252525" strokeWidth="1.5" strokeLinejoin="round" />
                </svg>
            </label>
