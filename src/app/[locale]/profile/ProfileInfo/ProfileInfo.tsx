...
const RenderProfileInfo = () => {
	...
	return (
		<form
			...
			className='lg:grid lg:grid-cols-2 gap-5 p-8 bg-white rounded-[16px]'
		>
			...
			<div className='space-y-1 mb-4'>
				<label
					htmlFor='isntapay_account'
					className='text-[#656C77] text-[16px] leading-[24px] font-[500]'
				>
					{t("isntapay_account_label")}
				</label>
				<input
					type='text'
					id='isntapay_account'
			...
			<Button type='submit' className='col-span-2 w-36 ml-auto'>
