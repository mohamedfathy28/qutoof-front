	...
	return (
		<>
			<div className='w-full overflow-hidden'>
				...
				/>
				<div className='py-2'>
					<h2 className='text-[24px] lg:text-[28px] font-[500] mb-2 lg:mb-3 text-[#121212]'>
						{ProjectInfo.title}
					</h2>
					<p className='text-[#525252] text-[16px] lg:text-[20px] mb-4 line-clamp-2 h-[65px]'>
						{ProjectInfo.description}
					</p>
					<ul className='grid grid-cols-2 mb-8'>
						<li className='flex flex-col lg:flex-row items-center gap-2'>
							<span className='text-[#656565] text-[12px] lg:text-[16px]'>
								{t("numberOfAcres")}:
							</span>
							<span className='text-[#121212] text-[12px] lg:text-[16px] font-[500]'>
								{ProjectInfo.total_area} {t("acres")}
							</span>
						</li>
						<li className='flex flex-col lg:flex-row items-center gap-2'>
							<span className='text-[#656565] text-[12px] lg:text-[16px]'>
							...
							<span className='text-[#121212] text-[12px] lg:text-[16px] font-[500]'>
								{ProjectInfo.sectors_count}
							</span>
						</li>
					</ul>
					<div className='flex items-center justify-between'>
						<Link
							href={`/our-projects/${ProjectInfo.id}/sectors`}
							className='flex items-start w-fit gap-2 hover:gap-4 transition-all duration-300 leading-[27px] text-[14px] lg:text-[18px] text-[#009444]'
						>
							{t("ShowSectors")}{" "}
							<svg
						...
						<Button
							...
							onClick={() => handleDownload(ProjectInfo.pdf)}
						>
							{t("Download")}
							<svg
								width='24'
