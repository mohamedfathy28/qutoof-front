    ...
    <>
      <div className="w-full overflow-hidden">
        ...
        <div className="py-3">
          ...
          <h2 className="text-[24px] font-[500] mb-3 text-gray-800">{blogInfo?.title}</h2>
          </Link>
          <p className="text-[#525252] text-[16px]  mb-4 line-clamp-3">{blogInfo?.content}</p>
          <Link href={`/news-articles/${blogInfo?.id}`} className='flex items-start w-fit gap-2 hover:gap-4 transition-all duration-300 leading-[14px] text-[14px] text-[#009444]'>
