		...
		const fetchData = async () => {
			...
			try {
				const response = await fetch(
					"https://quttouf.com/api/user/market",
					{
						headers: myHeaders,
					}
				);
		...
		<div className='mx-auto max-w-[90%] sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl mb-20 md:mb-32 flex flex-col items-center'>
			<div className='text-center mb-12'>
				...
				<h2
					...
					data-aos-duration='500'
					data-aos-delay='0'
					className='text-[26px] md:text-[40px] text-[#252525] font-[500] max-w-[550px]'
				>
					&quot;{t("ExploreInvest")}&quot;
				</h2>
			</div>
			...
			<div
				...
				data-aos-duration='500'
				data-aos-delay='0'
				className='w-full grid grid-cols-1 md:grid-cols-3 gap-8 mb-6'
			>
				{data ? (
