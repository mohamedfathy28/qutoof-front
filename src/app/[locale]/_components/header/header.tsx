				...
				<div className='flex justify-between items-center py-2 max-w-[90%] mx-auto sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl'>
					...
					>
						...
						{initialUser ? (
							<ul className='w-full lg:hidden border-t border-[#fff] mt-8 pt-4'>
								<li className='w-full'>
									<button
										...
										className='w-full flex justify-center items-center text-white gap-3 cursor-pointer px-4 py-2 outline-0 border-0 bg-transparent focus:outline-0 focus:border-0 focus:bg-transparent text-sm md:text-base'
									>
										<BiUser /> {t("Profile")}
									</button>
								</li>
								<li className='w-full'>
									<button
										className='w-full flex justify-center items-center gap-3 cursor-pointer px-4 py-2 outline-0 border-0 bg-transparent focus:outline-0 focus:border-0 focus:bg-transparent text-sm md:text-base text-red-600'
							...
							<li className='w-full flex flex-col justify-center gap-4 p-8 lg:hidden'>
								<Link
									href='/auth/signup'
											...
											<ul className='w-full bg-white rounded-[8px] overflow-hidden'>
												<li className='w-full hover:bg-gray-200'>
													<button
														...
														className='w-full flex justify-start items-center gap-3 cursor-pointer px-4 py-2 outline-0 border-0 bg-transparent focus:outline-0 focus:border-0 focus:bg-transparent text-sm md:text-base'
													>
														<BiUser /> {t("Profile")}
													</button>
												</li>
												<li className='w-full hover:bg-gray-200'>
													<button
														className='w-full flex justify-start items-center gap-3 cursor-pointer px-4 py-2 outline-0 border-0 bg-transparent focus:outline-0 focus:border-0 focus:bg-transparent text-sm md:text-base text-red-600'
														onClick={handleLogout}
													>
														<IoMdExit /> {t("logout")}
													</button>
